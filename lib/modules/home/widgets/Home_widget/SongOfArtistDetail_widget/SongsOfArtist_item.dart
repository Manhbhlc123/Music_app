...
class SongsofartistItem extends StatelessWidget {
  final SongItemModel songItemModel;
  // final VoidCallback onRemove;

  const SongsofartistItem({super.key, required this.songItemModel});
  ...
  Widget build(BuildContext context) {
    return ListTile(
      onTap: () async {
        ...
        await playerController.playSong(songItemModel);
      },
      leading: ClipRRect(
